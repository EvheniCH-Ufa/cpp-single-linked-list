// p06_02_06_VstavkaIUdalenieVProizvolnojPozicii.cpp 
...
class SingleLinkedList {
    ...
    public:
        ...
        BasicIterator& operator++() noexcept {
            BasicIterator iter = BasicIterator((*this).node_->next_node);
...
public:
    ...
    SingleLinkedList(std::initializer_list<Type> values) {
        size_ = 0;
        Node* current_node_ptr = &(this->head_);

        for (const auto& value : values)
        {
            current_node_ptr->next_node = new Node(value, nullptr);
            ++size_;
    ...
    SingleLinkedList(const SingleLinkedList& other) {
        ...
        auto it_new_list = tmp.begin();

        for (auto it = other.begin(); it != other.end(); ++it)
        {
            it_new_list.node_ = new Node(*it, nullptr);
            ++tmp.size_;
            ++it_new_list;
        }
    ...
    void swap(SingleLinkedList& other) noexcept {
        ...
        auto next_ptr_tmp = other.head_.next_node;
        auto size_tmp = other.size_;

        other.head_.next_node = (*this).head_.next_node;
        other.size_ = (*this).size_;

        (*this).head_.next_node = next_ptr_tmp;
        (*this).size_ = size_tmp;
    }
    ...
    [[nodiscard]] ConstIterator before_begin() const noexcept {
        ...
        return BasicIterator<const Type>(non_const_node);
    }
    ...
    [[nodiscard]] ConstIterator cbefore_begin() const noexcept {
        // Реализуйте самостоятельно++
        ConstIterator cit = before_begin();
        return cit;
    }
    ...
    Iterator InsertAfter(ConstIterator pos, const Type& value) {
        ...
        auto curr_node = pos.node_;
        Node* new_node = new Node(value, curr_node->next_node);
    ...
    void PopFront() noexcept {
        // Реализуйте метод самостоятельно
        auto curr_node = head_.next_node;
    ...
    Iterator EraseAfter(ConstIterator pos) noexcept {
        ...
        curr_node->next_node = del_node->next_node;
        --size_;
        delete del_node;
        return BasicIterator<Type>(curr_node->next_node);
    }
...
auto comp = [](const auto l_element, const auto r_element) {
...
bool operator<(const SingleLinkedList<Type>& lhs, const SingleLinkedList<Type>& rhs) {
    ...
    return  lexicographical_compare(lhs.cbegin(), lhs.cend(), rhs.cbegin(), rhs.cend(), comp);
}

template <typename Type>
bool operator<=(const SingleLinkedList<Type>& lhs, const SingleLinkedList<Type>& rhs) {
    // Заглушка. Реализуйте сравнение самостоятельно
    return  !lexicographical_compare(rhs.cbegin(), rhs.cend(), lhs.cbegin(), lhs.cend(), comp);
}
